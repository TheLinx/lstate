...
You need LuaFilesystem for this module to work.

h2. How to install (with LuaRocks)

Run the command _luarocks install http://github.com/TheLinx/luaSolidState/raw/rocks/luasolidstate-1.0.0-1.rockspec_
